...
public class CrimeReducer extends Reducer<Text, Text, Text, Text> {
	...
	public void reduce(Text key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
		if (key.toString().equals("Complaint_Number") || key.toString().equals("X-Coordinate") || key.toString().equals("Y-Coordinate")){
		...
		else if (key.toString().equals("Date_Crime_Committed")) {
		...
		else if (key.toString().equals("Offence_Code") || key.toString().equals("Borough") || key.toString().equals("Offence_Category") || key.toString().equals("Premises_Type")) {
		...
		else if (key.toString().equals("Offence_Description")) {
